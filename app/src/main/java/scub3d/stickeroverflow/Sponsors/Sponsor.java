...
public class Sponsor extends SponsorSummary implements Parcelable {
    ...
    public Sponsor(String id, String name, String description, String url, String location, String logoURL, ArrayList<StickerSummary> stickers, ArrayList<HackathonSummary> hackathons, ArrayList<User> members, ArrayList<User> admins) {
        this.id = id;
        this.name = name;
