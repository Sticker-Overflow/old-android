...
public class ResizableCameraPreview extends CameraPreview {
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        ...
        if (!mSurfaceConfiguring) {
            ...
            if (DEBUGGING) { Log.v("MyTag", "Desired Preview Size - w: " + width + ", h: " + height); }
        ...
        try {
            ...
            Log.w("MyTag", "Failed to start preview: " + e.getMessage());
        }
    }
    ...
    public void setPreviewSize(int index, int width, int height) {
        ...
        Camera.Size pictureSize = determinePictureSize(previewSize);
        if (DEBUGGING) { Log.v("MyTag", "Requested Preview Size - w: " + previewSize.width + ", h: " + previewSize.height); }
        mPreviewSize = previewSize;
        mPictureSize = pictureSize;
